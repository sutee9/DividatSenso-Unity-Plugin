...
namespace Dividat
{
    ...
    public class SensoManager : MonoBehaviour, IPlayBehaviour
    {
        ...
        [Tooltip("Log internal status updates of the Dividat Manager. Useful for debugging failed connections, but should be off by default.")]
        public bool logging = false;

        [Tooltip("Print logs generated by using SensoManager.Log / LogError and LogWarning while in the Unity Editor (Logs are never printed in Build, only sent to Dividat Play.)")]
        public bool simulateRemoteLogs = false;
